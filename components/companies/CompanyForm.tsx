...
export function CompanyForm({ company, type, mode }: CompanyFormProps) {
  ...
  const onSubmit = async (formData: FormData) => {
    try {
      ...
      const basePath = isMyCompanyType ? '/portal/my-companies' : '/portal/companies';
    ...
    <div className="min-h-screen bg-gray-50">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-xl font-semibold text-gray-900 flex items-center gap-3">
                  {isMyCompanyType ? '🏢' : '🏭'} {mode === 'edit' ? 'Edit' : 'Add'} {isMyCompanyType ? 'My Company' : 'External Company'}
                </h1>
                <p className="text-sm text-gray-500">
                  {mode === 'edit' ? 'Update' : 'Create'} company information and manage contacts, addresses, and shipping methods.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
            ...
            <CardHeader className="bg-gradient-to-r from-blue-50 to-indigo-50 border-b">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <CardDescription>Company name, code, and type</CardDescription>
                </div>
              </div>
            </CardHeader>
            ...
            <CardHeader className="bg-gradient-to-r from-green-50 to-emerald-50 border-b">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <CardTitle className="text-xl text-gray-900">Contacts</CardTitle>
                    <CardDescription>Manage contact persons for this company</CardDescription>
                  </div>
                </div>
                <Button 
                  type="button" 
            ...
            <CardHeader className="bg-gradient-to-r from-purple-50 to-violet-50 border-b">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <CardTitle className="text-xl text-gray-900">Addresses</CardTitle>
            ...
            <CardHeader className="bg-gradient-to-r from-orange-50 to-amber-50 border-b">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <CardTitle className="text-xl text-gray-900">Shipping Methods</CardTitle>
                    <CardDescription>Configure shipping companies and account details</CardDescription>
                  </div>
                </div>
                <Button 
                  type="button" 
          ...
          {/* Form Actions */}
          <div className="flex justify-end space-x-4 bg-white p-6 rounded-lg shadow-sm border">
            <Button 
              type="button" 
              variant="outline" 
              onClick={handleCancel}
