...
import { Plus, Search, Eye, Edit, Trash2, FileText, Wrench, Calendar } from 'lucide-react'
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-slate-500">Loading repair orders...</div>
      </div>
    )
  }
  ...
  return (
    <div className="space-y-4 px-2 pb-20">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
        ...
        <Button onClick={() => router.push('/portal/repair-orders/new')} className="w-full sm:w-auto">
