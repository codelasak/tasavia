...
export default function NewPurchaseOrderPage() {
  ...
  const onSubmit = async (data: PurchaseOrderFormValues) => {
    try {
      ...
      // Create the purchase order - omit po_number to let database generate it with the generate_po_number() function
      const insertData = {
        my_company_id: data.my_company_id,
        vendor_company_id: data.vendor_company_id,
        // po_number will be auto-generated by database default value
