...
import { Plus, Search, Eye, Edit, Trash2, FileText, Package, Truck } from 'lucide-react'
  ...
  return (
    <div className="space-y-4 px-2 pb-20">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
        ...
        <Button onClick={() => router.push('/portal/sales-orders/new')} className="w-full sm:w-auto">
