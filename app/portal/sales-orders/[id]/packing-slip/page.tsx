...
export default function PackingSlipPage({ params }: PackingSlipPageProps) {
  const router = useRouter()
  const [salesOrder, setSalesOrder] = useState<PackingSlipData | null>(null)
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-slate-500">Loading packing slip...</div>
      </div>
    )
  }
