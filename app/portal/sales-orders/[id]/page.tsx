...
import { ArrowLeft, Edit, FileText, Package, Truck, Download } from 'lucide-react'
...
export default function SalesOrderViewPage({ params }: SalesOrderViewPageProps) {
  const router = useRouter()
  const [salesOrder, setSalesOrder] = useState<SalesOrderDetails | null>(null)
