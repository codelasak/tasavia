-- Final fix for create_inventory_from_po_completion function
-- Remove the problematic quantity, condition, and status fields
-- Use proper enum fields for physical_status and business_status
...
BEGIN
    ...
    LOOP
        ...
        -- FIXED: Use only fields that exist in the inventory table
