-- Fix create_inventory_from_po_completion function to use proper enum status fields
-- and remove non-existent columns
...
BEGIN
    ...
    LOOP
        ...
        -- Insert inventory record with proper enum status values
        -- Fixed: Use physical_status and business_status enums instead of status text field
        -- Fixed: Remove quantity and condition columns that don't exist in inventory table
        INSERT INTO inventory (
            ...
            po_id_param,
            po_record.po_number,
            'depot'::physical_status_enum,     -- Default: items are at depot
            'available'::business_status_enum, -- Default: items are available for sale
